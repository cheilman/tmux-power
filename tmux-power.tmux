...
user=$(whoami)
LS="#[fg=$G04,bg=$TC,bold] $user_icon $user@#h #[fg=$TC,bg=$BG,nobold]$rarrow#[fg=$TC,bg=$BG] "
...
RS="#[fg=$G06,bg=$BG]$larrow#[fg=$TC,bg=$G06] $date_icon $date_format #[fg=$TC]$larrow#[fg=$G04,bg=$TC] $time_icon $time_format "
